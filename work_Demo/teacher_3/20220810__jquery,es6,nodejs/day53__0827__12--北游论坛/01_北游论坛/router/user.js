...
let fileconfig = require("../tools/fileConfig")
let multer = require("multer");
const upload = require("../tools/fileConfig");
// 用户注册
...
router.get("/islogin", (req, res) => {
    ...
    if (index == -1) {
        ...
        res.send({ code: 0, msg: "已登录", data: { username: tokenState[index].username } })
    }
})
...
router.post("/user/upload",upload. (req, res) => {
